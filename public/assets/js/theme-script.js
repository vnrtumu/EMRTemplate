...
document.addEventListener("DOMContentLoaded", function(e) {
	...
	<div class="sidebar-contact">
    	<div class="toggle-theme"  data-bs-toggle="offcanvas" data-bs-target="#theme-settings-offcanvas"><i class="ti ti-settings fa-spin"></i></div>
    </div>
                        ...
                        <div class="accordion-body">
                        	<div class="theme-content">
								...
								<div class="d-flex align-items-center flex-wrap mb-1">
									<div class="custom-themecolor m-1 me-2">
								...
								<div class="d-flex align-items-center flex-wrap gap-2">
									...
									<div class="custom-themecolor m-1">
                        ...
                        <div class="accordion-body pb-1">
                            <div class="theme-content">
                                ...
                                <div class="d-flex align-items-center flex-wrap topbar-background mb-1">
                                    <div class="custom-themecolor mb-3 me-3">
                                    ...
                                    <div class="custom-themecolor mb-3">
                                ...
                                <div class="d-flex align-items-center flex-wrap topbar-background">
                                    ...
                                    <div class="custom-themecolor mb-3 me-0">
                ...
                <div class="accordion-item">
                    ...
                    <div id="sidebarcolor" class="accordion-collapse collapse show">
                        <div class="accordion-body pb-2">
                            <div class="theme-content">
                                <div class="d-flex align-items-center flex-wrap gap-2 topbar-background">
