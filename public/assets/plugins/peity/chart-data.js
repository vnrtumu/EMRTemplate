...
$(function() {
    ...
    $(".bar-colours-1").peity("bar", {
        fill: ["#1F6DB2", "#1F6DB2", "#1F6DB2", "#EEF2F7", "#1F6DB2"],
        width: '66',
        height: '51'
    })
    $(".bar-colours-2").peity("bar", {
        fill: ["#09800F", "#09800F", "#EEF2F7", "#09800F", "#EEF2F7"],
        width: '66',
        height: '51'
    })
    $(".bar-colours-3").peity("bar", {
        fill: ["#0A694D", "#EEF2F7", "#0A694D", "#EEF2F7", "#0A694D"],
        width: '66',
        height: '51'
    })
    ...
    $(".bar-colours-5").peity("bar", {
        fill: ["#1F6DB2", "#1976D2", "#FDAF22", "#09800F", "#B71C1C", "#303F9F", "#E8EEFE", "#E8EEFE", "#E8EEFE", "#E8EEFE"],
        width: '100',
        height: '52'
    })
    ...
    $(".pie-colours-2").peity("pie", {
		fill: ["#1F6DB2", "#1976D2", "#FDAF22", "#09800F", "#B71C1C"],
        width: '100',
        height: '100'
    })
