...
<div className="content">
            ...
            <div className="card border-0 shadow-sm border-0 shadow-sm mb-0">
                <div className="card-header d-flex align-items-center flex-wrap gap-2 justify-content-between">
                    <h6 className="d-inline-flex align-items-center mb-0">Total Lab Results <span className="badge bg-danger ms-2">658</span></h6>
                ...
                <div className="card-body">
                    ...
                    <div className="table-responsive table-nowrap">
                            ...
                            <tbody>
                                                                    <tr>
                                        <td><a href="#" data-bs-toggle="modal" data-bs-target="#view_modal">#TE0025</a></td>
                                        <td>
                                        ...
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <Link to="/doctor-details" className="avatar avatar-xs me-2">
                                                    <img src="/assets/img/doctors/doctor-01.jpg" alt="doctors" className="rounded" />
                                                </Link>
                                                <div>
                                        ...
                                        <td>Blood Test</td>
                                        <td>
                                                                                        <span className="badge badge-soft-success">Received</span>
                                        </td>
                                            ...
                                            <ul className="dropdown-menu p-2">
                                                ...
                                                <li>
                                                    <a href="#/" className="dropdown-item d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#delete_modal"><i className="ti ti-trash me-1"></i>Delete</a>
                                                                    ...
                                                                    <tr>
                                        <td><a href="#" data-bs-toggle="modal" data-bs-target="#view_modal">#TE0024</a></td>
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <Link to="/patient-details" className="avatar avatar-xs me-2">
                                        ...
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <Link to="/doctor-details" className="avatar avatar-xs me-2">
                                                    <img src="/assets/img/doctors/doctor-03.jpg" alt="doctors" className="rounded" />
                                                </Link>
                                                <div>
                                            ...
                                            <ul className="dropdown-menu p-2">
                                                ...
                                                <li>
                                                    <a href="#/" className="dropdown-item d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#delete_modal"><i className="ti ti-trash me-1"></i>Delete</a>
                                                                    ...
                                                                    <tr>
                                        <td><a href="#" data-bs-toggle="modal" data-bs-target="#view_modal">#TE0023</a></td>
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <Link to="/patient-details" className="avatar avatar-xs me-2">
                                        ...
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <Link to="/doctor-details" className="avatar avatar-xs me-2">
                                                    <img src="/assets/img/doctors/doctor-04.jpg" alt="doctors" className="rounded" />
                                                </Link>
                                                <div>
                                            ...
                                            <ul className="dropdown-menu p-2">
                                                ...
                                                <li>
                                                    <a href="#/" className="dropdown-item d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#delete_modal"><i className="ti ti-trash me-1"></i>Delete</a>
                                                                    ...
                                                                    <tr>
                                        <td><a href="#" data-bs-toggle="modal" data-bs-target="#view_modal">#TE0022</a></td>
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <Link to="/patient-details" className="avatar avatar-xs me-2">
                                        ...
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <Link to="/doctor-details" className="avatar avatar-xs me-2">
                                                    <img src="/assets/img/doctors/doctor-05.jpg" alt="doctors" className="rounded" />
                                                </Link>
                                                <div>
                                            ...
                                            <ul className="dropdown-menu p-2">
                                                ...
                                                <li>
                                                    <a href="#/" className="dropdown-item d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#delete_modal"><i className="ti ti-trash me-1"></i>Delete</a>
                                                                    ...
                                                                    <tr>
                                        <td><a href="#" data-bs-toggle="modal" data-bs-target="#view_modal">#TE0021</a></td>
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <Link to="/patient-details" className="avatar avatar-xs me-2">
                                        ...
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <Link to="/doctor-details" className="avatar avatar-xs me-2">
                                                    <img src="/assets/img/doctors/doctor-06.jpg" alt="doctors" className="rounded" />
                                                </Link>
                                                <div>
                                            ...
                                            <ul className="dropdown-menu p-2">
                                                ...
                                                <li>
                                                    <a href="#/" className="dropdown-item d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#delete_modal"><i className="ti ti-trash me-1"></i>Delete</a>
                                                                    ...
                                                                    <tr>
                                        <td><a href="#" data-bs-toggle="modal" data-bs-target="#view_modal">#TE0020</a></td>
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <Link to="/patient-details" className="avatar avatar-xs me-2">
                                        ...
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <Link to="/doctor-details" className="avatar avatar-xs me-2">
                                                    <img src="/assets/img/doctors/doctor-07.jpg" alt="doctors" className="rounded" />
                                                </Link>
                                                <div>
                                            ...
                                            <ul className="dropdown-menu p-2">
                                                ...
                                                <li>
                                                    <a href="#/" className="dropdown-item d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#delete_modal"><i className="ti ti-trash me-1"></i>Delete</a>
                                                                    ...
                                                                    <tr>
                                        <td><a href="#" data-bs-toggle="modal" data-bs-target="#view_modal">#TE0019</a></td>
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <Link to="/patient-details" className="avatar avatar-xs me-2">
                                        ...
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <Link to="/doctor-details" className="avatar avatar-xs me-2">
                                                    <img src="/assets/img/doctors/doctor-10.jpg" alt="doctors" className="rounded" />
                                                </Link>
                                                <div>
                                            ...
                                            <ul className="dropdown-menu p-2">
                                                ...
                                                <li>
                                                    <a href="#/" className="dropdown-item d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#delete_modal"><i className="ti ti-trash me-1"></i>Delete</a>
                                                                    ...
                                                                    <tr>
                                        <td><a href="#" data-bs-toggle="modal" data-bs-target="#view_modal">#TE0018</a></td>
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <Link to="/patient-details" className="avatar avatar-xs me-2">
                                        ...
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <Link to="/doctor-details" className="avatar avatar-xs me-2">
                                                    <img src="/assets/img/doctors/doctor-08.jpg" alt="doctors" className="rounded" />
                                                </Link>
                                                <div>
                                            ...
                                            <ul className="dropdown-menu p-2">
                                                ...
                                                <li>
                                                    <a href="#/" className="dropdown-item d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#delete_modal"><i className="ti ti-trash me-1"></i>Delete</a>
                                                                    ...
                                                                    <tr>
                                        <td><a href="#" data-bs-toggle="modal" data-bs-target="#view_modal">#TE0017</a></td>
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <Link to="/patient-details" className="avatar avatar-xs me-2">
                                        ...
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <Link to="/doctor-details" className="avatar avatar-xs me-2">
                                                    <img src="/assets/img/doctors/doctor-12.jpg" alt="doctors" className="rounded" />
                                                </Link>
                                                <div>
                                            ...
                                            <ul className="dropdown-menu p-2">
                                                ...
                                                <li>
                                                    <a href="#/" className="dropdown-item d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#delete_modal"><i className="ti ti-trash me-1"></i>Delete</a>
                                                                    ...
                                                                    <tr>
                                        <td><a href="#" data-bs-toggle="modal" data-bs-target="#view_modal">#TE0016</a></td>
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <Link to="/patient-details" className="avatar avatar-xs me-2">
                                        ...
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <Link to="/doctor-details" className="avatar avatar-xs me-2">
                                                    <img src="/assets/img/doctors/doctor-11.jpg" alt="doctors" className="rounded" />
                                                </Link>
                                                <div>
