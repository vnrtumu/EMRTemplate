                                ...
                                <div className="row align-items-center gy-4">
                                    <div className="col-lg-5">
                                        <div>
                                            ...
                                            <p className="mb-1 text-body">15 Hodges Mews, High Wycombe HP12 3JL, <br /> United Kingdom</p>
                                            <p className="mb-0 text-body">Phone : +1 45659 96566</p>
                                        </div>
                                    </div> 
                                    ...
                                    <div className="col-lg-5">
                                        <div>
                                            ...
                                            <p className="mb-1 text-body">1147 Rohan Drive Suite, Burlington, VT / 8202115 <br /> United Kingdom</p>
                                            <p className="mb-0 text-body">Phone : +1 36254 56589</p>
                                        </div>
                                    </div> 
                                ...
                                <div className="col-xl-7">
                                    <div className="mb-3">
                                        ...
                                        <div className="bg-soft-info text-info rounded mt-3 p-3">
                                            <p className="mb-0"><span className="fw-semibold">Note :</span> Payment for all accounts is due within 7 days from the date of invoice receipt. Payments can be made via cheque, credit card, or direct online payment. Failure to settle the account within 7 days will result in the agreed quoted fee,</p>
                                        </div>
                                    </div>
                                </div>
