...
<div className="content pb-0">
            ...
            <div className="breadcrumb-arrow mb-4">
                <h4 className="mb-1">Data Tables</h4>
                <div className="text-end">
                    <ol className="breadcrumb m-0 py-0">
                        <li className="breadcrumb-item"><Link to="/" className="text-decoration-none">Home</Link></li>
                        <li className="breadcrumb-item"><Link to="#/" className="text-decoration-none">Tables</Link></li>
                        ...
                        <div className="card-body">
                            <div className="table-search d-flex align-items-center">
                                <div className="search-input">
                                    <a href="#/" className="btn-searchset"><i className="isax isax-search-normal fs-12"></i></a>
                                </div>
                            </div>
                            <div className="table-responsive">
                                <table className="table table-nowrap datatable border">
                                    <thead>
                                        <tr>
                                            <th>Name</th>
                                            <th>Position</th>
