...
<div className="content pb-0">
            ...
            <div className="breadcrumb-arrow mb-4">
                <h4 className="mb-1">Form Validation</h4>
                ...
                <div className="col-sm-12">
                    ...
                    <div className="card border-0 shadow-sm">
                        ...
                        <div className="card-body">
                            <p>For custom Bootstrap form validation messages, you’ll need to add the <code>novalidate</code> boolean attribute to your form. For server side validation <a href="https://getbootstrap.com/docs/4.1/components/forms/#server-side" target="_blank" className="text-primary">read full documentation</a>.</p>
                                    ...
                                    <form className="needs-validation" novalidate>
                                        <div className="form-row row">
                                            <div className="col-md-4 mb-3">
                                                <label className="form-label" htmlFor="validationCustom01">First Name
                                                </label>
                                            ...
                                            <div className="col-md-4 mb-3">
                                                ...
                                                <div className="input-group">
                                                    ...
                                                    <input type="text" className="form-control" id="validationCustomUserName" placeholder="User Name" aria-describedby="inputGroupPrepend" required />
                            ...
                            <div className="row">
                                <div className="col-sm">
                                    <form>
                                        <div className="form-row row">
                                            <div className="col-md-4 mb-3">
                                                <label className="form-label" htmlFor="validationDefault01">First Name
                                                </label>
                                                <input type="text" className="form-control" id="validationDefault01" placeholder="First Name" value="Mark" required />
                                            </div>
                                            <div className="col-md-4 mb-3">
                                                <label className="form-label" htmlFor="validationDefault02">Last Name
                                                </label>
                                                <input type="text" className="form-control" id="validationDefault02" placeholder="Last Name" value="Otto" required />
                                            </div>
                                            <div className="col-md-4 mb-3">
                                                <label className="form-label" htmlFor="validationDefaultUserName">User Name</label>
                                                <div className="input-group">
                                                    <span className="input-group-text" id="inputGroupPrepend2">@</span>
                                                    <input type="text" className="form-control" id="validationDefaultUserName" placeholder="User Name" aria-describedby="inputGroupPrepend2" required />
                                                </div>
                                            </div>
                                        </div>
                                        <div className="form-row row">
                        ...
                        <div className="card-body">
                            ...
                            <form>
                                <div className="form-row row">
                                    ...
                                    <div className="col-md-4 mb-3">
                                        <label className="form-label" htmlFor="validationServerUserName">User Name</label>
                                        <div className="input-group input-grp">
                                            <span className="input-group-text" id="inputGroupPrepend3">@</span>
                                            <input type="text" className="form-control is-invalid" id="validationServerUserName" placeholder="User Name" aria-describedby="inputGroupPrepend3" required />
                                            <div className="invalid-feedback">
                                                Please choose a User Name.
                                            </div>
                                        </div>
                                ...
                                <div className="col-sm">
                                    <form className="was-validated">
                                        ...
                                        <div className="form-check mb-3">
                                            ...
                                            <label className="form-check-label" htmlFor="validationFormCheck1">Check this checkbox
                                            </label>
                                        ...
                                        <div className="form-check">
                                            ...
                                            <label className="form-check-label" htmlFor="validationFormCheck2">Toggle this radio
                                            </label>
                                        </div>
                                        <div className="form-check mb-3">
                    ...
                    <div className="card border-0 shadow-sm">
                        ...
                        <div className="card-body">
                            ...
                            <form className="row g-3 needs-validation" novalidate>
                                ...
                                <div className="col-md-4 position-relative">
                                    <label htmlFor="validationTooltipUserName" className="form-label">User Name</label>
