                                    ...
                                    <div className="d-flex flex-column justify-content-lg-center flex-fill">
                                        <div className="card border-0 shadow-sm border-1 p-lg-3 shadow-md rounded-3 m-0">
                                            <div className="card-body">
                                                ...
                                                <div className="mb-3">
                                                    <h5 className="mb-1 fw-bold">Hi, Welcome Back</h5>
                                                </div>
                                                <div className="mb-3">
                                                ...
                                                <div className="d-flex align-items-center justify-content-between mb-3">
                                                    <div className="d-flex align-items-center">
                                                        <div className="form-check form-check-md mb-0">
                                                            ...
                                                            <label htmlFor="remember_me" className="form-check-label mt-0 text-body">Remember Me</label>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="mb-2">
                                                    <button type="submit" className="btn bg-primary text-white w-100">Sign In</button>
                                                </div>
                                                ...
                                                <div className="text-center">
                                                    <h6 className="fw-normal fs-14 text-body mb-0">Don’t have an account?
                                                        <Link to="/sign-up" className="ms-1 text-primary">Sign Up</Link>
                                                    </h6>
                                                </div>
                                            </div>
                                        </div>
