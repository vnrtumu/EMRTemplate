...
<div className="content pb-0">
            ...
            <div className="breadcrumb-arrow mb-4">
                <h4 className="mb-1">Utilities</h4>
            ...
            <div className="row">
                ...
                <div className="col-xl-6">
                    <div className="card border-0 shadow-sm">
                        ...
                        <div className="card-body">
                            <p className="text-muted">Similar to the contextual text color classes, set the background of an element to any contextual class. Background utilities <strong>do not set <code>color</code></strong>, so in some cases you’ll want to use <code>.text-*</code>color utilities.</p>
                            ...
                            <div className="bg-dark text-white p-2 mb-2">.bg-dark</div>
                ...
                <div className="col-xl-6">
                    <div className="card card-h-100">
                        ...
                        <div className="card-body">
                            <p className="text-muted">By adding a <code>.bg-gradient</code> class, a linear gradient is added as background image to the backgrounds. This gradient starts with a semi-transparent white which fades out to the bottom.</p>
            ...
            <div className="row">
                ...
                <div className="col-xl-12">
                    <div className="card border-0 shadow-sm">
                        ...
                        <div className="card-body">
                            <p className="text-muted">Similar to the contextual text color classes, set the background of an element to any contextual class. Background utilities do not set <code>color</code>, so in some cases you’ll want to use <code>.text-*</code> <a href="https://getbootstrap.com/docs/5.3/utilities/colors/">color utilities</a>. </p>

                            <div className="row">
                                <div className="col-12">
                                    <div className="d-flex flex-column gap-2">
                                        <div className="bg-primary-subtle p-2"><code className="text-primary-emphasis">.bg-primary-subtle</code></div>
                                        <div className="bg-secondary-subtle p-2"><code className="text-secondary-emphasis">.bg-secondary-subtle </code></div>
                                        <div className="bg-success-subtle p-2"><code className="text-success-emphasis">.bg-success-subtle</code></div>
                                        <div className="bg-danger-subtle p-2"><code className="text-danger-emphasis">.bg-danger-subtle</code></div>
                                        <div className="bg-warning-subtle p-2"><code className="text-warning-emphasis">.bg-warning-subtle</code></div>
                        ...
                        <div className="card-body">
                            ...
                            <div className="row row-cols-12 d-flex align-items-center">
                                <div className="p-3 col">
                                    ...
                                    <p className="pb-0 mb-0 fw-semibold text-center"><code>.bg-primary-gradient</code>
                                    </p>
                                </div>
                                <div className="p-3 col">
                                    <div className="m-2 bg-secondary-gradient mx-auto color-container"></div>
                                    <p className="pb-0 mb-0 fw-semibold text-center"><code>.bg-secondary-gradient</code>
                                    </p>
                                </div>
                                <div className="p-3 col">
                                    <div className="m-2 bg-warning-gradient mx-auto color-container"></div>
                                    <p className="pb-0 mb-0 fw-semibold text-center"><code>.bg-warning-gradient</code>
                                    </p>
                                </div>
                                <div className="p-3 col">
                                    <div className="m-2 bg-info-gradient mx-auto color-container"></div>
                                    <p className="pb-0 mb-0 fw-semibold text-center"><code>.bg-info-gradient</code></p>
                                </div>
                                <div className="p-3 col">
                                    <div className="m-2 bg-success-gradient mx-auto color-container"></div>
                                    <p className="pb-0 mb-0 fw-semibold text-center"><code>.bg-success-gradient</code>
                                    </p>
                                </div>
                                <div className="p-3 col">
                                    <div className="m-2 bg-danger-gradient mx-auto color-container"></div>
                                    <p className="pb-0 mb-0 fw-semibold text-center"><code>.bg-danger-gradient</code>
                                    </p>
                                </div>
                                <div className="p-3 col">
                                    <div className="m-2 bg-light-gradient mx-auto color-container"></div>
                                    <p className="pb-0 mb-0 fw-semibold text-center"><code>.bg-light-gradient</code></p>
                                </div>
                                <div className="p-3 col">
                                    <div className="m-2 bg-dark-gradient mx-auto color-container"></div>
                                    <p className="pb-0 mb-0 fw-semibold text-center"><code>.bg-dark-gradient</code></p>
                                </div>
                            </div>
            ...
            <div className="row">
                ...
                <div className="col-xl-6">
                    <div className="card border-0 shadow-sm">
                        ...
                        <div className="card-body">
                            <p className="text-muted">Color and background helpers combine the power of our <code>.text-*</code> utilities and <code>.bg-*</code> utilities in one class. Using our Sass <code>color-contrast()</code> function, we automatically determine a contrasting <code>color</code> for a particular <code>background-color</code>.</p>
                            <div className="d-flex flex-column gap-2">
                                ...
                                <div className="text-bg-dark p-2">Dark with contrasting color ()</div>
                            </div>
                ...
                <div className="col-xl-6">
                    <div className="card card-h-100">
                        ...
                        <div className="card-body">
                            <p className="text-muted fs-14">You can use the <code>.link-*</code> classes to colorize links. Unlike the <code>.text-*</code> classes, these classes have a <code>:hover</code> and <code>:focus</code> state.</p>
                            <div className="d-flex flex-column gap-2">
                                <a href="#" className="link-primary text-decoration-none">Primary link</a>
            ...
            <div className="row">
                ...
                <div className="col-xl-12">
                    <div className="card border-0 shadow-sm">
                        ...
                        <div className="card-body">
                            <p className="text-muted"><code>background-color</code> utilities are generated with Sass using CSS variables. This allows for real-time color changes without compilation and dynamic alpha transparency changes.</p>
                ...
                <div className="col-xl-12">
                    <div className="card border-0 shadow-sm">
                        ...
                        <div className="card-body pb-1">
                            <p className="text-muted">Colorize text with color utilities. If you want to colorize links, you can use the <code>.link-*</code> helper classes which have <code>:hover</code> and <code>:focus</code> states.</p>
            ...
            <div className="row">
                ...
                <div className="col-xl-6">
                    <div className="card border-0 shadow-sm">
                        ...
                        <div className="card-body">
                            <p className="text-muted">text color utilities are generated with Sass using CSS variables. This allows for real-time color changes without compilation and dynamic alpha transparency changes.</p>
                        ...
                        <div className="card-body">
                            ...
                            <div className="d-flex align-items-start flex-wrap gap-4">
                                <div className="text-center">
                                    <div className="border avatar-xl bg-light bg-opacity-50"></div>
                                </div>
                                <div className="text-center">
                                    <div className="border-top avatar-xl bg-light bg-opacity-50"></div>
                                </div>
                                <div className="text-center">
                                    <div className="border-end avatar-xl bg-light bg-opacity-50"></div>
                                </div>
                                <div className="text-center">
                                    <div className="border-bottom avatar-xl bg-light bg-opacity-50"></div>
                                </div>
                                <div className="text-center">
                                    <div className="border-start avatar-xl bg-light bg-opacity-50"></div>
                                </div>
                            </div>
                ...
                <div className="col-xl-6">
                    <div className="card border-0 shadow-sm">
                        ...
                        <div className="card-body">
                            ...
                            <div className="d-flex align-items-start flex-wrap gap-4">
                                <div className="text-center">
                                    <div className="border border-0 avatar-xl bg-light bg-opacity-50"></div>
                                </div>
                                <div className="text-center">
                                    <div className="border border-top-0 avatar-xl bg-light bg-opacity-50"></div>
                                </div>
                                <div className="text-center">
                                    <div className="border border-end-0 avatar-xl bg-light bg-opacity-50"></div>
                                </div>
                                <div className="text-center">
                                    <div className="border border-bottom-0 avatar-xl bg-light bg-opacity-50"></div>
                                </div>
                                <div className="text-center">
                                    <div className="border border-start-0 avatar-xl bg-light bg-opacity-50"></div>
                                </div>
                            </div>
            ...
            <div className="row">
                ...
                <div className="col-xl-6">
                    <div className="card border-0 shadow-sm">
                        ...
                        <div className="card-body">
                            <p className="text-muted">Change the border color using utilities built on our theme colors.
                            </p>
                            <div className="d-flex align-items-start flex-wrap gap-2">
                                <div className="text-center">
                                    <div className="border border-primary avatar-xl bg-light bg-opacity-50"></div>
                                </div>
                                <div className="text-center">
                                    <div className="border border-secondary avatar-xl bg-light bg-opacity-50"></div>
                                </div>
                                <div className="text-center">
                                    <div className="border border-success avatar-xl bg-light bg-opacity-50"></div>
                                </div>
                                <div className="text-center">
                                    <div className="border border-danger avatar-xl bg-light bg-opacity-50"></div>
                                </div>
                                <div className="text-center">
                                    <div className="border border-warning avatar-xl bg-light bg-opacity-50"></div>
                                </div>
                                <div className="text-center">
                                    <div className="border border-info avatar-xl bg-light bg-opacity-50"></div>
                                </div>
                                <div className="text-center">
                                    <div className="border border-light avatar-xl"></div>
                                </div>
                                <div className="text-center">
                                    <div className="border border-dark avatar-xl bg-light bg-opacity-50"></div>
                                </div>
                            </div>
                        </div> 
                    </div> 
                    ...
                    <div className="card border-0 shadow-sm">
                        ...
                        <div className="card-body">
                            <div className="d-flex align-items-start flex-wrap gap-2">
                                <div className="text-center">
                                    <div className="border border-1 avatar-xl bg-light bg-opacity-50"></div>
                                </div>
                                <div className="text-center">
                                    <div className="border border-2 avatar-xl bg-light bg-opacity-50"></div>
                                </div>
                                <div className="text-center">
                                    <div className="border border-3 avatar-xl bg-light bg-opacity-50"></div>
                                </div>
                                <div className="text-center">
                                    <div className="border border-4 avatar-xl bg-light bg-opacity-50"></div>
                                </div>
                                <div className="text-center">
                                    <div className="border border-5 avatar-xl bg-light bg-opacity-50"></div>
                                </div>
                            </div>
                ...
                <div className="col-xl-12">
                    <div className="card border-0 shadow-sm">
                        ...
                        <div className="card-body">
                            ...
                            <div className="d-flex align-items-start flex-wrap gap-2">
                                <div className="text-center">
                                    <div className="border border-primary-subtle avatar-xl bg-light bg-opacity-50">
                                    </div>
                                </div>
                                <div className="text-center">
                                    <div className="border border-secondary-subtle avatar-xl bg-light bg-opacity-50">
                                    </div>
                                </div>
                                <div className="text-center">
                                    <div className="border border-success-subtle avatar-xl bg-light bg-opacity-50">
                                    </div>
                                </div>
                                <div className="text-center">
                                    <div className="border border-danger-subtle avatar-xl bg-light bg-opacity-50">
                                    </div>
                                </div>
                                <div className="text-center">
                                    <div className="border border-warning-subtle avatar-xl bg-light bg-opacity-50">
                                    </div>
                                </div>
                                <div className="text-center">
                                    <div className="border border-info-subtle avatar-xl bg-light bg-opacity-50">
                                    </div>
                                </div>
                                <div className="text-center">
                                    <div className="border border-light-subtle avatar-xl"></div>
                                </div>
                                <div className="text-center">
                                    <div className="border border-dark-subtle avatar-xl bg-light bg-opacity-50">
                                    </div>
                                </div>
                            </div>
            ...
            <div className="row">
                ...
                <div className="col-xl-6">
                    <div className="card border-0 shadow-sm">
                        ...
                        <div className="card-body">
                            ...
                            <div className="d-flex align-items-start flex-wrap gap-2">
                                <img src="/assets/img/avatars/avatar-39.jpg" className="avatar-lg rounded" alt="rounded" />
                                <img src="/assets/img/avatars/avatar-39.jpg" className="avatar-lg rounded-top" alt="rounded-top" />
                                <img src="/assets/img/avatars/avatar-39.jpg" className="avatar-lg rounded-end" alt="rounded-end" />
                                <img src="/assets/img/avatars/avatar-39.jpg" className="avatar-lg rounded-bottom" alt="rounded-bottom" />
                                <img src="/assets/img/avatars/avatar-39.jpg" className="avatar-lg rounded-start" alt="rounded-start" />
                                <img src="/assets/img/avatars/avatar-39.jpg" className="avatar-lg rounded-circle" alt="rounded-circle" />
                                <img src="/assets/img/avatars/avatar-37.jpg" className="avatar-lg w-auto rounded-pill" alt="rounded-pill" />
                            </div>
                ...
                <div className="col-xl-6">
                    <div className="card border-0 shadow-sm">
                        ...
                        <div className="card-body">
                            <p className="text-muted">Use the scaling classes for larger or smaller rounded corners. Sizes range from <code>0</code> to <code>5</code>.</p>
                            <div className="d-flex align-items-start flex-wrap gap-2">
                                <img src="/assets/img/avatars/avatar-51.jpg" className="avatar-lg rounded-0" alt="rounded-0" />
                                <img src="/assets/img/avatars/avatar-51.jpg" className="avatar-lg rounded-1" alt="rounded-1" />
                                <img src="/assets/img/avatars/avatar-51.jpg" className="avatar-lg rounded-2" alt="rounded-2" />
                                <img src="/assets/img/avatars/avatar-51.jpg" className="avatar-lg rounded-3" alt="rounded-3" />
                                <img src="/assets/img/avatars/avatar-51.jpg" className="avatar-lg rounded-4" alt="rounded-4" />
                                <img src="/assets/img/avatars/avatar-51.jpg" className="avatar-lg rounded-5" alt="rounded-5" />
                            </div>
                        </div> 
                    </div> 
                </div> 
            ...
            <div className="row">
                ...
                <div className="col-xl-6">
                    <div className="card border-0 shadow-sm">
                        ...
                        <div className="card-body">
                            <p className="text-muted">Use <code>user-select-all</code>, <code>user-select-auto</code>, or <code>user-select-none</code> class to the content which is selected when the user interacts with it. </p>
                ...
                <div className="col-xl-6">
                    <div className="card border-0 shadow-sm">
                        ...
                        <div className="card-body">
                            <p className="text-muted">Bootstrap provides <code>.pe-none</code> and <code>.pe-auto</code> classes to prevent or add element interactions.</p>
                            <p><a href="#" className="pe-none" tabIndex="-1">This link</a> can not be clicked.</p>
                            <p><a href="#" className="pe-auto">This link</a> can be clicked (this is default behavior).</p>
                            <p className="pe-none mb-0"><a href="#" tabIndex="-1">This link</a> can not be clicked because the <code>pointer-events</code> property is inherited from its parent. However, <a href="#" className="pe-auto">this link</a> has a <code>pe-auto</code> class and can be clicked.</p>
                        </div> 
                    </div> 
                </div> 
            ...
            <div className="row">
                ...
                <div className="col-xl-12">
                    <div className="card border-0 shadow-sm">
                        ...
                        <div className="card-body">
                            <p className="text-muted">Adjust the <code>overflow</code> property on the fly with four default values and classes. These classes are not responsive by default.</p>
            ...
            <div className="row">
                ...
                <div className="col-xl-6">
                    <div className="card border-0 shadow-sm">
                        ...
                        <div className="card-body">
                            <p className="text-muted">Arrange elements easily with the edge positioning utilities. The format is <code>{property}-{position}</code>.</p>
                ...
                <div className="col-xl-6">
                    <div className="card border-0 shadow-sm">
                        ...
                        <div className="card-body">
                            <p className="text-muted">In addition, you can also center the elements with the transform utility class <code>.translate-middle</code>.</p>
            ...
            <div className="row">
                ...
                <div className="col-xl-6">
                    <div className="card border-0 shadow-sm">
                        ...
                        <div className="card-body">
                            <p className="text-muted">By adding <code>.translate-middle-x</code> or <code>.translate-middle-y</code> classes, elements can be positioned only in horizontal or vertical direction. </p>
            ...
            <div className="row">
                ...
                <div className="col-xl-6">
                    <div className="card border-0 shadow-sm">
                        ...
                        <div className="card-body">
                            <p className="text-muted">Width utilities are generated from the utility API in <code>_utilities.scss</code>. Includes support for <code>25%</code>, <code>50%</code>, <code>75%</code>, <code>100%</code>, and <code>auto</code> by default. Modify those values as you need to generate different utilities here.</p>
                ...
                <div className="col-xl-6">
                    <div className="card border-0 shadow-sm">
                        ...
                        <div className="card-body">
                            <p className="text-muted">Height utilities are generated from the utility API in <code>_utilities.scss</code>. Includes support for <code>25%</code>, <code>50%</code>, <code>75%</code>, <code>100%</code>, and <code>auto</code> by default. Modify those values as you need to generate different utilities here.</p>
                            <div className="d-flex flex-wrap gap-2 align-items-start overflow-hidden" style={{ height: 255 }}>
                                ...
                                <div className="h-auto p-2 bg-light">auto</div>
                            </div>
            ...
            <div className="row">
                <div className="col-xl-12">
                    <div className="card border-0 shadow-sm">
                        ...
                        <div className="card-body">
                            <p className="text-muted">Change the value of the <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/object-fit"><code>object-fit</code> property</a> with our responsive <code>object-fit</code> utility classes. This property tells the content to fill the parent container in a variety of ways, such as preserving the aspect ratio or stretching to take up as much space as possible.</p>
                            <div className="d-flex align-items-start flex-wrap gap-3 text-center">
                                <div>
                                    <img src="/assets/img/media/img-2.jpg" className="object-fit-contain border rounded avatar-xl" alt="..." />
                                    <p className="mt-1 mb-0"><code className="user-select-all">.object-fit-contain</code></p>
                                </div>
                                <div>
                                    <img src="/assets/img/media/img-2.jpg" className="object-fit-cover border rounded avatar-xl" alt="..." />
                                    <p className="mt-1 mb-0"><code className="user-select-all">.object-fit-cover</code></p>
                                </div>
                                <div>
                                    <img src="/assets/img/media/img-2.jpg" className="object-fit-fill border rounded avatar-xl" alt="..." />
                                    <p className="mt-1 mb-0"><code className="user-select-all">.object-fit-fill</code></p>
                                </div>
                                <div>
                                    <img src="/assets/img/media/img-2.jpg" className="object-fit-scale border rounded avatar-xl" alt="..." />
                                    <p className="mt-1 mb-0"><code className="user-select-all">.object-fit-scale</code></p>
                                </div>
                                <div>
                                    <img src="/assets/img/media/img-2.jpg" className="object-fit-none border rounded avatar-xl" alt="..." />
                ...
                <div className="col-xl-12">
                    <div className="card border-0 shadow-sm">
                        ...
                        <div className="card-body pb-0">
                            <p className="text-muted">Use <code>z-index</code> utilities to stack elements on top of one another. Requires a <code>position</code> value other than <code>static</code>, which can be set with custom styles or using our position utilities.</p>

                            <div className="bd-example-zindex-levels position-relative">

                                <div className="z-3 position-absolute p-5 rounded-3 bg-primary"><span>z-3</span></div>
                                <div className="z-2 position-absolute p-5 rounded-3 bg-success"><span>z-2</span></div>
                                <div className="z-1 position-absolute p-5 rounded-3 bg-warning"><span>z-1</span></div>
                                <div className="z-0 position-absolute p-5 rounded-3 bg-danger"><span>z-0</span></div>
                                <div className="z-n1 position-absolute p-5 rounded-3 bg-info"><span>z-n1</span></div>
