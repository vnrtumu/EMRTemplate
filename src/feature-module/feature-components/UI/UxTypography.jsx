...
<div className="content pb-0">
            ...
            <div className="breadcrumb-arrow mb-4">
                <h4 className="mb-1">Typography</h4>
            ...
            <div className="row">
                ...
                <div className="col-xl-4">
                    <div className="card border-0 shadow-sm">
                        ...
                        <div className="card-body">
                            <p className="text-muted"><strong>This only applies to immediate children list items</strong>, meaning you will need to add the class for any nested lists as well.</p>
                            ...
                            <h5>Inline</h5>
                            <p className="text-muted m-b-15">Place all list items on a single line with <code>display: inline-block;</code> and some light padding.</p>
            ...
            <div className="row">
                ...
                <div className="col-xl-4">
                    <div className="card card-h-100">
                        ...
                        <div className="card-body">
                            <p className="text-muted">Use text utilities as needed to change the alignment of your
                                blockquote.</p>
            ...
            <div className="row">
                ...
                <div className="col-xl-6">
                    <div className="card card-h-100">
                        ...
                        <div className="card-body">
                            <p className="text-muted">For quoting blocks of content from another source within your document. Wrap <code>&lt;blockquote className="blockquote"&gt;</code> around any <abbr title="PacesText Markup Language">HTML</abbr> as the quote.</p>
                            <blockquote className="blockquote">
                                <p className="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p>
                            </blockquote>
                            <figure> <figcaption className="blockquote-footer">Someone famous in <cite title="Source Title">Source Title</cite></figcaption></figure>
                            <p className="text-muted m-b-15">Use text utilities as needed to change the alignment of your blockquote.</p>
                            <blockquote className="blockquote text-center">
                                <p className="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p>
                            </blockquote>
                            <figure><figcaption className="blockquote-footer text-center">Someone famous in <cite title="Source Title">Source Title</cite></figcaption></figure>
                            <blockquote className="blockquote text-end">
                                <p className="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p>
                            </blockquote>
                            <figure className="mb-0"><figcaption className="blockquote-footer text-end mb-0">Someone famous in <cite title="Source Title">Source Title</cite></figcaption></figure>
                        </div> 
                    </div> 
                </div> 
                ...
                <div className="col-xl-6">
                    <div className="card border-0 shadow-sm">
                        ...
                        <div className="card-body">
                            <p className="text-muted">Align terms and descriptions horizontally by using our grid system’s predefined classes (or semantic mixins). For longer terms, you can optionally add a <code>.text-truncate</code> class to truncate the text with an ellipsis.</p>
                            <dl className="row mb-0">
                                ...
                                <dd className="col-sm-9 mb-0">
                                    <dl className="row mb-0">
                                        ...
                                        <dd className="col-sm-8 mb-0">Aenean posuere, tortor sed cursus feugiat, nunc augue blandit nunc.</dd>
                                    </dl>
                                </dd>
                            </dl>
