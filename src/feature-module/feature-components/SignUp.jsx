                    ...
                    <div className="col-lg-6 col-md-12 col-sm-12">
                        <div className="row justify-content-center align-items-center overflow-auto flex-wrap vh-100">
                            <div className="col-md-8 mx-auto">
                                <form action="https://dreamsemr.dreamstechnologies.com/php/template/login.php" className="d-flex justify-content-center align-items-center">
                                    <div className="d-flex flex-column justify-content-lg-center flex-fill">
                                        <div className="card border-0 shadow-sm border-1 p-lg-3 shadow-md rounded-3 m-0">
                                            <div className="card-body">
                                                ...
                                                <div className="mb-3">
                                                    <label className="form-label">Username<span className="text-danger ms-1">*</span></label>
                                                    <div className="input-group input-group-flat">
                                                        <input type="text" value="" className="form-control border-end-0" />
                                                        <span className="input-group-text bg-white">
                                                            <i className="ti ti-user fs-14 text-dark"></i>
                                                        </span>
                                                    </div>
                                                </div>
                                                <div className="mb-3">
                                                ...
                                                <div className="mb-2">
                                                    <button type="submit" className="btn bg-primary text-white w-100">Create account</button>
                                                </div>
