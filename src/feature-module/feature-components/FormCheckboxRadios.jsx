...
<div className="content pb-0">
            ...
            <div className="breadcrumb-arrow mb-4">
                <h4 className="mb-1">Checks & Radios</h4>
                    ...
                    <div className="card border-0 shadow-sm">
                        ...
                        <div className="card-body">
                            ...
                            <div className="mb-3">
                                ...
                                <input type="checkbox" className="btn-check" id="btn-check-3" disabled />
                                <label className="btn btn-primary" htmlFor="btn-check-3">Disabled</label>
                            </div>
                            <div>
                                <input type="checkbox" className="btn-check" id="btn-check-4" />
                                <label className="btn" htmlFor="btn-check-4">Single toggle</label>

                                <input type="checkbox" className="btn-check" id="btn-check-5" defaultChecked />
                                <label className="btn" htmlFor="btn-check-5">Checked</label>

                                <input type="checkbox" className="btn-check" id="btn-check-6" disabled />
                                <label className="btn" htmlFor="btn-check-6">Disabled</label>
                            </div>
                ...
                <div className="col-lg-6">
                    <div className="card border-0 shadow-sm">
                        ...
                        <div className="card-body">
                            ...
                            <div>
                                <input type="radio" className="btn-check" name="options-base" id="option5" defaultChecked />
                                <label className="btn" htmlFor="option5">Checked</label>

                                <input type="radio" className="btn-check" name="options-base" id="option6" />
                                <label className="btn" htmlFor="option6">Radio</label>

                                <input type="radio" className="btn-check" name="options-base" id="option7" disabled />
                                <label className="btn" htmlFor="option7">Disabled</label>

                                <input type="radio" className="btn-check" name="options-base" id="option8" />
                                <label className="btn" htmlFor="option8">Radio</label>
                            </div>
                    ...
                    <div className="card border-0 shadow-sm border-0 shadow-sm card-h-100">
                        ...
                        <div className="card-body">
                            ...
                            <div className="form-check form-switch form-check-reverse">
                                <input className="form-check-input" type="checkbox" id="switchCheckReverse" />
                    ...
                    <div className="card border-0 shadow-sm">
                        ...
                        <div className="card-body">
                            ...
                            <div className="form-check form-switch">
                                <input className="form-check-input" type="checkbox" role="switch" id="switchCheckCheckedDisabled" defaultChecked disabled />
                                <label className="form-check-label" htmlFor="switchCheckCheckedDisabled">Disabled checked switch checkbox input</label>
                            </div>
